...
## Overview
FocusGuardian blocks distracting websites on macOS by modifying your `/etc/hosts` file. When you try to visit a blocked site, it redirects you to a local reminder page with motivational quotes.
